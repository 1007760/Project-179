...
class game() :
    ...
    def __update_score(self, input_value) :
        ...
        if input_value == self.color[self.random_number_for_color] :
            ...
            self.__score = self.__score + random.radint(0, 10)
...
btn2 = Button(root, text="START" ,command=obj.updateGame, bg="dark olive green", fg="white", relief=FLAT,  padx=10, pady=1,  font=("Arial",15))
